			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				<div className="mx-auto max-w-5xl">
					...
					<motion.div
						...
						className="rounded-xl border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-secondary/5 p-8 text-center"
					>
						<div className="flex flex-col items-center gap-4">
							<Zap className="h-12 w-12 text-primary" />
							<div>
								<h3 className="mb-2 text-xl font-bold">Ready to explore?</h3>
