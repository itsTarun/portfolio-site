...
import { ArrowRight, Code2, Rocket, Sparkles, Github, Linkedin, Twitter, Mail } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/50">
      <div className="container mx-auto px-4 py-20 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            {[
              { icon: Github, href: 'https://github.com/itsTarun', label: 'GitHub' },
              { icon: Linkedin, href: 'https://linkedin.com/in/itsTarun', label: 'LinkedIn' },
              { icon: Twitter, href: 'https://twitter.com/itsTarun', label: 'Twitter' },
              { icon: Mail, href: 'mailto:itstarun1994@gmail.com', label: 'Email' },
            ].map((social) => (
              <motion.a
                key={social.label}
                href={social.href}
          ...
          >
            {[
              ...
              },
              {
                icon: Sparkles,
                title: 'UI/UX Design',
                description: 'Framer Motion, Responsive Design, Prototyping',
              ...
              >
                ...
                <div className="relative">
                  <div className={`mb-4 inline-flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br ${card.gradient} text-white shadow-lg`}>
